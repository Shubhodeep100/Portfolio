      ...
      <ul>
        {links.map(({id, child, href, style, download}) => (
          <li
            key={id}
            className={
              "flex justify-between items-center w-40 h-10 px-4 ml-[-140px] hover:ml-[-10px] hover:rounded-md duration-300 rounded-r-lg bg-gray-500" +
              " " +
              style
            }
          >
